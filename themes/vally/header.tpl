	...
	{if !$content_only}
		...
		<div id="page">
			<div class="header-container" id="container">
				...
				<ul>
				     <li><a href="{$base_dir}">Bienvenue chez VALLY</a></li>  
					 <li><a href="{$base_dir}?controller=my-account">My Account</a></li>
					 <li><a href="{$base_dir}/index.php?controller=history">Order Status</a></li>
					 <li><a href="#">Wish Lists </a></li>
					 <li><a href="{$base_dir}/index.php?controller=my-account">Sign In</a></li>
					 <li><a href="{$base_dir}/index.php?controller=my-account">Create Account</a></li>
				 </ul>
							</div>
						</div>
					</div>
